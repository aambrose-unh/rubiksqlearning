...
class cube:
    ...
    def clockwise(self):
        ...
        # refState.showCube()
        # Rotate outer
        # self.left[:,1] = refState.getFace(refState.cubeState,'bottom')[0,:]
        # self.top[1,:] = refState.getFace(refState.cubeState,'left')[:,1]
        # self.right[:,0] = refState.getFace(refState.cubeState,'top')[1,:]
        # self.bottom[0,:] = refState.getFace(refState.cubeState,'right')[:,0]
    ...
    def counterclockwise(self):
        ...
        # self.left[:,1] = refState.getFace(refState.cubeState,'top')[1,:]
        # self.top[1,:] = refState.getFace(refState.cubeState,'right')[:,0]
        # self.right[:,0] = refState.getFace(refState.cubeState,'bottom')[0,:]
        # self.bottom[0,:] = refState.getFace(refState.cubeState,'left')[:,1]

        # Rotate main face
        # self.front = np.rot90(refState.getFace(refState.cubeState,'front'), axes=(0,1))
    ...
    def forward(self):
        ...
        refState = self.copy()
        # Rotate outer
        self.front[:,0] = self.getFace(refState.cubeState,'top')[:,0]
        self.top[:,0] = self.getFace(refState.cubeState,'back')[:,1]
        self.back[:,1] = self.getFace(refState.cubeState,'bottom')[:,0]
        self.bottom[:,0] = self.getFace(refState.cubeState,'front')[:,0]

        # Rotate main face
        self.left = np.rot90(self.getFace(refState.cubeState,'left'), axes=(1,0))
    ...
    def backward(self):
        ...
        refState = self.copy()
        # Rotate outer
        self.front[:,0] = self.getFace(refState.cubeState,'bottom')[:,0]
        self.top[:,0] = self.getFace(refState.cubeState,'front')[:,0]
        self.back[:,1] = self.getFace(refState.cubeState,'top')[:,0]
        self.bottom[:,0] = self.getFace(refState.cubeState,'back')[:,1]

        # Rotate main face
        self.left = np.rot90(self.getFace(refState.cubeState,'left'), axes=(0,1))
